...
func TestContext(t *testing.T) {
	...
	rec = httptest.NewRecorder()
	c = NewContext(req, NewResponse(rec), New())
	assert.Equal(t, nil, c.Redirect(http.StatusMovedPermanently, "http://santoshanand.github.io/spark"))
...
func TestContextQuery(t *testing.T) {
	...
	assert.Equal(t, "joe@yopmail.com", c.Query("email"))
...
func TestContextForm(t *testing.T) {
	...
	assert.Equal(t, "joe@yopmail.com", c.Form("email"))
}
